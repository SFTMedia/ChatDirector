...
public class BungeeInputItem extends PassItem implements Listener {
    ...
    public boolean isValid() {
        return ValidationUtils.anyOf(disconnect,switchServers,chat,joinServer,command)&&ValidationUtils.hasContent(formatDisconnect,formatSwitch,formatChat,formatJoin);
    }
}
