            ...
            if (proxiedPlayer == null
                ...
                if (!sendToCurrentServer && context.containsKey("SERVER_NAME")) {
                    if (proxiedPlayer.getServer() != null && proxiedPlayer.getServer().getInfo() != null
                        ...
                        ChatDirector.logDebug("Server name matches player (" + proxiedPlayer.getName() + ") server >"
                ...
                proxiedPlayer.sendMessage(message); // Since we want to do context resolution per player we need to
                                                    // duplicate
