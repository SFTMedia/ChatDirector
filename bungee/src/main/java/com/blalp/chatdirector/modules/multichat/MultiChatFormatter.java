...
public class MultiChatFormatter extends Formatter {
    ...
    public Map<String, String> getContext(Object event) {
        ...
        if(event instanceof PostGlobalChatEvent) {
            ...
            context.putAll(ChatDirector.formatter.getContext(((PostGlobalChatEvent)event).getSender()));
        ...
        if(event instanceof PostStaffChatEvent) {
            ...
            context.putAll(ChatDirector.formatter.getContext(((PostStaffChatEvent)event).getSender()));
